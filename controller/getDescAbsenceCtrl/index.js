...
const controller = {
  getDescAbsence(request, response) {
    ...
    const { employee_id, dateInTimestamp } = request.body;
    ...
    try {
      pool.db_MMFPROD.query(
        ...
        extract(isodow from TIMESTAMP $2) as  hari_ke, b.day_type, 
        ...
        left join work_schedule_cycle_tbl b on b.schedule_type = a.schedule_type 
                               and b.day_sequence=extract(isodow from TIMESTAMP $2)
